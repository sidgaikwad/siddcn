            ...
            {mounted && (
              ...
              >
                {theme === "dark" ? (
                  ...
                  <svg className="w-5 h-5 fill-current transition-transform group-hover:rotate-90" viewBox="0 0 24 24" role="img" aria-labelledby="sunIconTitle">
                    <title id="sunIconTitle">Switch to light theme</title>
                  ...
                  <svg className="w-5 h-5 fill-current transition-transform group-hover:-rotate-12" viewBox="0 0 24 24" role="img" aria-labelledby="moonIconTitle">
                    <title id="moonIconTitle">Switch to dark theme</title>
          ...
          >
            <nav className="flex flex-col p-4 space-y-2">
              ...
              <div className="flex gap-4 px-4 py-2">
                <a href="https://x.com/_sidd24_" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-white">X (Twitter)</a>
                <a href="https://github.com/sidgaikwad/siddcn" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-white flex items-center gap-2">
                  GitHub
