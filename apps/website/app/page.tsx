        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <div className="bg-terminal-bg/50 border border-terminal-cyan/30 rounded-lg p-6 backdrop-blur-sm">
              <p className="text-terminal-cyan text-sm mb-2">Install globally</p>
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <a 
              href="https://github.com/yourusername/siddcn"
              target="_blank"
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-terminal-bg/80 border border-terminal-cyan/30 rounded-lg p-8 text-left">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="ml-2 text-terminal-text/60 text-sm">terminal</span>
            </div>
      ...
      <footer className="py-12 px-4 sm:px-6 lg:px-8 border-t border-terminal-text/10">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              <h4 className="text-terminal-text font-semibold mb-4">Documentation</h4>
              <ul className="space-y-2 text-sm text-terminal-text/60">
                <li><Link href="/docs/getting-started" className="hover:text-terminal-cyan">Getting Started</Link></li>
                <li><Link href="/docs/installation" className="hover:text-terminal-cyan">Installation</Link></li>
                <li><Link href="/docs/components" className="hover:text-terminal-cyan">Components</Link></li>
                <li><Link href="/docs/api" className="hover:text-terminal-cyan">API Reference</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-terminal-text/60">
                <li><Link href="/components" className="hover:text-terminal-cyan">Component Library</Link></li>
                <li><Link href="/examples" className="hover:text-terminal-cyan">Examples</Link></li>
                <li><Link href="/docs/adding-components" className="hover:text-terminal-cyan">Add Components</Link></li>
                <li><Link href="/docs/contributing" className="hover:text-terminal-cyan">Contributing</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-terminal-text/60">
                <li><a href="https://github.com/yourusername/siddcn" className="hover:text-terminal-cyan">GitHub</a></li>
                <li><a href="https://twitter.com/siddcn" className="hover:text-terminal-cyan">Twitter</a></li>
                <li><a href="https://discord.gg/siddcn" className="hover:text-terminal-cyan">Discord</a></li>
                <li><a href="https://npmjs.com/package/siddcn" className="hover:text-terminal-cyan">npm</a></li>
              </ul>
            </div>
          </div>
